...
//  CONFIGURATION
// ─────────────────────────────────────────────
const DELAY_BETWEEN_PROXIES_MS = 30 * 1000; // minimum 30s between proxies — change here if needed
const DELAY_AFTER_LINK = 10 * 1000; // wait after link before opening earnapp dashboard
...
async function main() {
  ...
  for (let i = 0; i < proxies.length; i++) {
    ...
    try {
      ...
      sleep(1000); // wait a bit before cleanup to ensure dashboard updates
